...
title-slide-attributes:
  data-background-image: /img/rtve.jpeg
...
`R` es el [**lenguaje estadístico por excelencia**]{.hl-yellow}, creado por y para estadísticos/as, con 4 ventajas fundamentales [**frente a Excel**]{.hl-red}:
...
* `NA`: [**dato ausente**]{.hl-yellow} son las siglas de _not available_.
...
También podemos hacer uso de [**operaciones estadísticas**]{.hl-yellow}
como por ejemplo `sum()` que, dado un vector, nos devuelve la suma de todos sus elementos.
